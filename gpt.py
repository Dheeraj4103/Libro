...
def recommend(query):
    ...
    return data.iloc[recommended_books_indices][["Title", "Authors"]]

# Now, when you call the recommend function, it will consider both titles, authors, and descriptions for recommendations
result = recommend("give me books on computer graphics")
print(result)
